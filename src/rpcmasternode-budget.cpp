...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a RSTR initiative\n"
            "  vote-alias         - Vote on a RSTR initiative\n"
            "  vote               - Vote on a RSTR initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"rstr-address\" monthy-payment\n"
            ...
            "5. \"rstr-address\":   (string, required) RSTR address to send payments to\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.rstr.io/t/test-proposal\" 2 820800 \"TKsuLoLmRt9PYWg9MAaRK1M8KcmST1jNnu\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.rstr.io/t/test-proposal\" 2 820800 \"TKsuLoLmRt9PYWg9MAaRK1M8KcmST1jNnu\" 500"));
    ...
    CWalletTx wtx;
    if (!pwalletMain->GetBudgetSystemCollateralTX(wtx, budgetProposalBroadcast.GetHash(), useIX)) { // 50 RST collateral for proposal
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"rstr-address\" monthy-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.rstr.io/t/test-proposal\" 2 820800 \"TKsuLoLmRt9PYWg9MAaRK1M8KcmST1jNnu\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.rstr.io/t/test-proposal\" 2 820800 \"TKsuLoLmRt9PYWg9MAaRK1M8KcmST1jNnu\" 500"));
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) RSTR address of payment\n"
