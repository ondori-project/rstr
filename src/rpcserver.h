...
extern UniValue setzrstseed(const UniValue& params, bool fHelp);
extern UniValue getzrstseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzrst(const UniValue& params, bool fHelp);
extern UniValue dzrststate(const UniValue& params, bool fHelp);
