                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRSTPathCustom = GetArg("-zrstbackuppath", "");
    ...
    if(!strzRSTPathCustom.empty()) {
        ui->wallet_customzrstbackuppath->setText(QString::fromStdString(strzRSTPathCustom));
        ui->wallet_customzrstbackuppath_label->setVisible(true);
        ui->wallet_customzrstbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRSTPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the RSTR RPC console.") + "<br>" +
