                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("RSTR Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RSTR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rstr: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zRST"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RSTR Core"), this);
    aboutAction->setStatusTip(tr("Show information about RSTR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RSTR"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RSTR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RSTR addresses"));
    ...
    openAction->setStatusTip(tr("Open a RSTR: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RSTR Core help message to get a list with possible RSTR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("RSTR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RSTR network", "", count));
}
...
{
    QString strTitle = tr("RSTR Core"); // default title
