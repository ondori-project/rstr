...
CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 55000000000.0)
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RSTR features */
        {"rstr", "masternode", &masternode, true, true, false},
        {"rstr", "listmasternodes", &listmasternodes, true, true, false},
        {"rstr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"rstr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"rstr", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"rstr", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"rstr", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"rstr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"rstr", "masternodedebug", &masternodedebug, true, true, false},
        {"rstr", "startmasternode", &startmasternode, true, true, false},
        {"rstr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"rstr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"rstr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"rstr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"rstr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"rstr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"rstr", "mnbudget", &mnbudget, true, true, false},
        {"rstr", "preparebudget", &preparebudget, true, true, false},
        {"rstr", "submitbudget", &submitbudget, true, true, false},
        {"rstr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"rstr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"rstr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"rstr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"rstr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"rstr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"rstr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rstr", "checkbudgets", &checkbudgets, true, true, false},
        {"rstr", "mnsync", &mnsync, true, true, false},
        {"rstr", "spork", &spork, true, true, false},
        {"rstr", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzrstseed", &getzrstseed, false, false, true},
        {"zerocoin", "setzrstseed", &setzrstseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzrst", &searchdzrst, false, false, true},
        {"zerocoin", "dzrststate", &dzrststate, false, false, true}
...
{
    return "> rstr-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22619/\n";
}
