Contributing to RSTR Core
============================

The RSTR Core project operates an open contributor model where anyone is
welcome to contribute towards rstelopment in the form of peer review, testing
...
The following applies to code changes to the RSTR Core project, and is not to be
confused with overall RSTR Network Protocol consensus changes.

Whether a pull request is merged into RSTR Core rests with the project merge
...
Patches that change RSTR consensus rules are considerably more involved than
...
Where a patch set proposes to change the RSTR consensus, it must have been
...
The project leader is the release manager for each RSTR Core release.
