...
Apple uses clang extensively for rstelopment and has upstreamed the necessary
...
To obtain it, register for a developer account, then download the [Xcode 7.3.1 dmg](https://developer.apple.com/rstcenter/download.action?path=/Developer_Tools/Xcode_7.3.1/Xcode_7.3.1.dmg).
...
- **TODO** The Apple keyholder uses this unsigned app to create a detached signature,
  using the script that is also included there. Detached signatures are available from this [repository](https://github.com/rstr-coin/rstr-detached-sigs).
