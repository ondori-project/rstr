Multiwallet Qt Rstelopment and Integration Strategy
===================================================

In order to support loading of multiple wallets in rstr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rstr.cpp.
...
Changes to rstr.cpp
----------------------
rstr.cpp is the entry point into rstr-qt, and as such, will require some minor modifications to provide hooks for
