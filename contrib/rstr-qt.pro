...
RESOURCES += src/qt/rstr.qrc src/qt/rstr_locale.qrc

TRANSLATIONS += src/qt/locale/rstr_bg.ts \
                src/qt/locale/rstr_de.ts \
                src/qt/locale/rstr_en.ts \
                src/qt/locale/rstr_es.ts \
                src/qt/locale/rstr_fi.ts \
                src/qt/locale/rstr_fr.ts \
                src/qt/locale/rstr_it.ts \
                src/qt/locale/rstr_ja.ts \
                src/qt/locale/rstr_pl.ts \
                src/qt/locale/rstr_pt.ts \
                src/qt/locale/rstr_ru.ts \
                src/qt/locale/rstr_sk.ts \
                src/qt/locale/rstr_sv.ts \
                src/qt/locale/rstr_vi.ts \
                src/qt/locale/rstr_zh_CN.ts \
                src/qt/locale/rstr_zh_TW.ts
